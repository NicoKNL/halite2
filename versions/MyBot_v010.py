...
class CommandCenter(object):
    ...
    def execute_tasks(self):
        ...
        for unit in self.units:
            ...
            if task == "stay_docked" or ship.docking_status == hlt.entity.Ship.DockingStatus.DOCKED:
    ...
    def avoid_danger(self, unit):
        ...
        for planet in self.empty_planets:  # This should probably not be here
        ...
        return ship.thrust(hlt.constants.MAX_SPEED, direction)
    ...
    def collonize_planet(self, unit):
        ...
        if ship.can_dock(planet) and planet not in self.enemy_planets:
